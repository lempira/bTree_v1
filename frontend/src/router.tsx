...
// COMMENTED OUT: Wallet-based sign-in removed - now using account creation flow
...
// Simplified stub - redirects to account creation flow
function SubjectSignIn() {
  return (
    <div className="space-y-2">
      <h2 className="font-semibold">Sign In</h2>
      <p className="text-sm text-neutral-700">
        Please create an account or sign in from the header.
      </p>
    </div>
  );
}
