...
// COMMENTED OUT: Blockchain network configuration removed
...
// COMMENTED OUT: Wallet provider wrapper removed - now using simple sessionStorage for per-tab accounts
